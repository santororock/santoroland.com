...
function toggleNav() {
  ...
  if (toggleBool == 'inactive'){
    ...
    document.getElementById("s-layout-content-header").classList.add("sidebar-active");
    ...
    document.getElementById("s-layout-content-header").classList.remove("sidebar-active");
