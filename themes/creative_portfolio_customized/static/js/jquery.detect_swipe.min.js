    ...
    function n(n) {
        if (e.detectSwipe.preventDefault && n.preventDefault(), c) {
            var i, s = n.touches[0].pageX,
                ...
                r = o - s,
                a = h - u;
            Math.abs(r) >= e.detectSwipe.threshold ? i = r > 0 ? "left" : "right" : Math.abs(a) >= e.detectSwipe.threshold && (i = a > 0 ? "down" : "up"), i && (t.call(this), e(this).trigger("swipe", i).trigger("swipe" + i))
        }
    }
